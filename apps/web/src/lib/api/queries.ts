...
export function apiQueries(client: IptvApiClient = apiClient) {
  return {
    ...
    jobs: queryOptions({ queryKey: ['jobs'], queryFn: () => client.getJobs() }),
    operatorApiTokens: queryOptions({ queryKey: ['operator-api-tokens'], queryFn: () => client.getOperatorApiTokens() }),
    supportBundle: queryOptions({ queryKey: ['support', 'bundle'], queryFn: () => client.getSupportBundle() }),
    supportLogs: queryOptions({ queryKey: ['support', 'logs'], queryFn: () => client.getSupportLogs() }),
