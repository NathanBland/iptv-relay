...
pub const REGION_PREFIXES: &[&str] = &[
    "US", "USA", "CAN", "EN", "UK", "AU", "NZ",
    "LA", "BR", "ESP", "PT", "IT", "FR", "QC", "DE", "AT", "CH",
    "NL", "BE", "SE", "DK", "NO", "FI", "SCAN", "IS",
    "PL", "GR", "BG", "RO", "HU", "CZ", "SK", "SL",
    "AL", "RS", "HR", "MK", "BH", "KO", "EXYU",
    "RU", "BY", "UKR", "LT", "LV", "EE", "EST",
    "TR", "IR", "ARA", "AF", "AFRICAN", "AFG",
    "IN", "PK", "LK", "BAN",
    "PH", "ID", "TH", "VT", "MY", "SG", "HK", "CN", "JP", "SK", "TW", "KA",
    "GLOBAL", "MULTI", "EU", "SPT", "MU",
];
...
pub fn suggested_prefixes_for_timezone(timezone: &str) -> Vec<&'static str> {
    ...
    let regional: &[&str] = match timezone {
        ...
        | "America/Halifax" | "America/Winnipeg" | "America/Saskatoon"
        | "US/Eastern" | "US/Central" | "US/Mountain" | "US/Pacific"
        | "US/Arizona" | "Canada/Eastern" | "Canada/Central"
        | "Canada/Mountain" | "Canada/Pacific" => &["US", "USA", "CAN", "EN", "LA"],

        // Latin America
        "America/Mexico_City" | "America/Bogota" | "America/Lima"
        | "America/Buenos_Aires" | "America/Santiago" | "America/Sao_Paulo"
        | "America/Caracas" | "America/Guatemala" | "America/Havana" => &["LA", "BR", "ES", "PT"],

        // UK and Ireland
        "Europe/London" | "Europe/Dublin" | "GMT" | "Etc/GMT"
        | "Atlantic/Reykjavik" => &["UK", "EN"],

        // Western Europe
        "Europe/Paris" | "Europe/Brussels" | "Europe/Amsterdam"
        | "Europe/Luxembourg" | "Europe/Madrid" | "Europe/Lisbon"
        | "CET" => &["FR", "QC", "ESP", "PT", "NL", "BE", "EN"],

        // Central Europe
        "Europe/Berlin" | "Europe/Vienna" | "Europe/Zurich"
        | "Europe/Rome" | "Europe/Athens" | "Europe/Malta" => &["DE", "AT", "CH", "IT", "GR", "EN"],

        // Northern Europe / Scandinavia
        "Europe/Stockholm" | "Europe/Copenhagen" | "Europe/Oslo"
        | "Europe/Helsinki" | "Europe/Tallinn" => &["SE", "DK", "NO", "FI", "SCAN", "EN"],

        // Eastern Europe
        "Europe/Warsaw" | "Europe/Budapest" | "Europe/Prague"
        | "Europe/Sofia" | "Europe/Bucharest" | "Europe/Bratislava"
        | "Europe/Ljubljana" | "Europe/Zagreb" | "Europe/Belgrade"
        | "Europe/Skopje" | "Europe/Sarajevo" | "Europe/Podgorica"
        | "Europe/Tirane" | "Europe/Vilnius" | "Europe/Riga" | "Europe/Kiev" => {
            &["PL", "CZ", "SK", "HU", "BG", "RO", "SL", "EXYU", "AL", "LT", "LV", "UKR"]
        }

        // Russia and neighbors
        "Europe/Moscow" | "Europe/Kaliningrad" | "Europe/Minsk"
        | "Asia/Yekaterinburg" | "Asia/Novosibirsk" | "Asia/Vladivostok" => {
            &["RU", "BY", "UKR"]
        }

        // Middle East
        "Asia/Jerusalem" | "Asia/Riyadh" | "Asia/Dubai" | "Asia/Qatar"
        | "Asia/Kuwait" | "Asia/Bahrain" | "Asia/Baghdad" | "Asia/Beirut"
        | "Asia/Damascus" | "Asia/Amman" | "Africa/Cairo" => &["ARA", "IS", "TR"],
        ...
        | "Asia/Kathmandu" => &["IN", "PK", "BAN", "LK", "EN"],
        ...
        | "Asia/Taipei" | "Asia/Ulaanbaatar" => &["JP", "SK", "CN", "HK", "TW", "EN"],

        // Central Asia
        "Asia/Almaty" | "Asia/Tashkent" | "Asia/Baku" | "Asia/Yerevan"
        | "Asia/Tbilisi" => &["KA", "RU", "EN"],

        // Africa
        "Africa/Johannesburg" | "Africa/Lagos" | "Africa/Nairobi"
        | "Africa/Casablanca" | "Africa/Accra" | "Africa/Addis_Ababa"
        | "Africa/Algiers" | "Africa/Tunis" | "Africa/Dakar" => &["AF", "AFRICAN", "ARA", "FR", "EN"],

        // Oceania
        "Australia/Sydney" | "Australia/Melbourne" | "Australia/Brisbane"
        | "Australia/Perth" | "Pacific/Auckland" | "Pacific/Fiji" => &["AU", "NZ", "EN"],
